...
/* Create  Data of The Date for Use in Query  */
;WITH seq(n) AS 
(
  SELECT 0 
  UNION ALL 
...
--**********************************************************************
-- เงื่อนไข
-- 5. งานที่สำเร็จจากฝ่าย CS ทั้ง SA และ OA  กี่ FormID  รวมเป็นรายวัน (summary รายเดือน) 
--**********************************************************************
...
-- Department : CS
-- Action : New customer(1),New customer(2),New customer(4),Change Program Trade(10)
-- Satus : Check(4)
------------------
...
Where SAlfh_Delflag = 0
And SAlfh_SAmfa_Id  IN(1,2,3,4,10)
...
--select * from #His where SAlfh_LogDate = '2020-06-08'
